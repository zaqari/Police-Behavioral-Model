...
setwd("/Volumes/V\'GER/comp_ling/SocialJusticeInitiatives/PoliceReform/")
library(R2jags)
library(ggplot2)
...
myinits <- list(list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5)),
                list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5)),
                list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5))
)
...
myinits <- list(list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5), 'sigma'=matrix(runif(1,0,1),3,5), 'delta'=runif(1,0,1)),
                list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5), 'sigma'=matrix(runif(1,0,1),3,5), 'delta'=runif(1,0,1)),
                list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5), 'sigma'=matrix(runif(1,0,1),3,5), 'delta'=runif(1,0,1))
)
...
myinits <- list(list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5), 'sigma'=matrix(runif(1,0,1),3,5), 'delta'=rep(runif(1,0,1),5)),
                list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5), 'sigma'=matrix(runif(1,0,1),3,5), 'delta'=rep(runif(1,0,1),5)),
                list('theta'=matrix(runif(1,0,1),5,3), 'N'=matrix(nmax,3,5), 'sigma'=matrix(runif(1,0,1),3,5), 'delta'=rep(runif(1,0,1),5))
)

parameters <- c('theta', 'delta', 'sigma', 'N')
...
myinits <- list(list('theta'=matrix(runif(1,0,1),5,3), 'delta'=rep(runif(1,0,1),5)),
                list('theta'=matrix(runif(1,0,1),5,3), 'delta'=rep(runif(1,0,1),5)),
                list('theta'=matrix(runif(1,0,1),5,3), 'delta'=rep(runif(1,0,1),5))
)

parameters <- c('theta', 'N', 'delta', 'sigma')
